...
We can use ``wishbone-tool`` to write values to ``0x00003000`` (or whatever
your ``build/csr.csv`` says) and see them take effect immediately.

.. session:: shell-session

   $ wishbone-tool 0x00003000 0x1 # make LED green
   $ wishbone-tool 0x00003000 0x2 # make LED red
   $ wishbone-tool 0x00003000 0x3 # make LED yellow
   $ wishbone-tool 0x00003000 0x4 # make LED blue
   $ wishbone-tool 0x00003000 0x5 # make LED teal
   $ wishbone-tool 0x00003000 0x6 # make LED pink
   $ wishbone-tool 0x00003000 0x7 # make LED white
